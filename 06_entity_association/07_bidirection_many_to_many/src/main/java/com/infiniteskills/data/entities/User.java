...
public class User {
	...
	public Set<AccountBiDirectionalManyToMany> getAccounts() { return accounts; }

	public void setAccounts(Set<AccountBiDirectionalManyToMany> accounts) { this.accounts = accounts; }
}
