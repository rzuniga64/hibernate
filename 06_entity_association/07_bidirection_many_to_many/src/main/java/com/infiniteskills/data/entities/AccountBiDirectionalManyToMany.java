...
public class AccountBiDirectionalManyToMany {
	...
	List<TransactionBiDirectionalManyToMany> transactions = new ArrayList<TransactionBiDirectionalManyToMany>();
	...
	public List<TransactionBiDirectionalManyToMany> getTransactions() {
		return transactions;
	}

	public void setTransactions(List<TransactionBiDirectionalManyToMany> transactions) {
